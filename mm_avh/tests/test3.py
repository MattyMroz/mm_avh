...
# wypisz wszystkie opcje translatora
for i, translator in enumerate(data['TRANSLATORS'], start=1):
    print(f"{i}. {translator['name']}")
    if 'suboptions' in translator:
        for j, suboption in enumerate(translator['suboptions'], start=1):
            print(f"   {i}.{j}. {suboption['name']}")
